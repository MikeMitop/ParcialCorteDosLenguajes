...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUEVO = 3,                      /* NUEVO  */
  YYSYMBOL_BUSCAR = 4,                     /* BUSCAR  */
  YYSYMBOL_ACTUALIZAR = 5,                 /* ACTUALIZAR  */
  YYSYMBOL_ELIMINAR = 6,                   /* ELIMINAR  */
  YYSYMBOL_DONDE = 7,                      /* DONDE  */
  YYSYMBOL_ASIGNAR = 8,                    /* ASIGNAR  */
  ...
  YYSYMBOL_STRING_LIT = 15,                /* STRING_LIT  */
  ...
  YYSYMBOL_sentencia = 26,                 /* sentencia  */
  YYSYMBOL_create_op = 27,                 /* create_op  */
  YYSYMBOL_read_op = 28,                   /* read_op  */
  YYSYMBOL_update_op = 29,                 /* update_op  */
  YYSYMBOL_delete_op = 30,                 /* delete_op  */
  YYSYMBOL_condicion_opt = 31,             /* condicion_opt  */
  YYSYMBOL_condicion = 32,                 /* condicion  */
  YYSYMBOL_asignacion = 33,                /* asignacion  */
  YYSYMBOL_pares = 34,                     /* pares  */
  YYSYMBOL_par = 35,                       /* par  */
  YYSYMBOL_valor = 36,                     /* valor  */
  YYSYMBOL_operador = 37,                  /* operador  */
  YYSYMBOL_id = 38                         /* id  */
};
...
{
       0,   324,   324,   325,   329,   330,   331,   332,   337,   343,
     349,   355,   362,   366,   371,   383,   393,   395,   400,   413,
     415,   417,   419,   425,   426,   427,   428,   429,   430,   435
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUEVO", "BUSCAR",
  "ACTUALIZAR", "ELIMINAR", "DONDE", "ASIGNAR", "LBRACE", "RBRACE",
  "COLON", "COMMA", "NUL", "NUMBER", "STRING_LIT", "BOOLEAN", "IDENT",
  "EQ", "NEQ", "GT", "LT", "GTE", "LTE", "$accept", "programa",
  "sentencia", "create_op", "read_op", "update_op", "delete_op",
  "condicion_opt", "condicion", "asignacion", "pares", "par", "valor",
  "operador", "id", YY_NULLPTR
};
...
{
     -15,     4,   -15,     8,     8,     8,     8,   -15,   -15,   -15,
     -15,   -15,   -15,    18,    -1,    20,    -1,     8,     8,   -15,
       8,   -15,    19,    21,    23,   -15,     0,    -1,    12,   -15,
       8,    -2,   -15,   -15,   -15,   -15,   -15,   -15,    -2,   -15,
...
{
       2,     0,     1,     0,     0,     0,     0,     3,     4,     5,
       6,     7,    29,     0,    12,     0,    12,     0,     0,     9,
       0,    11,     0,    16,     0,    13,     0,    12,     0,     8,
       0,     0,    23,    24,    25,    26,    27,    28,     0,    10,
       0,    17,    22,    19,    20,    21,    18,    14,    15
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -15,   -15,   -15,   -15,   -15,   -15,   -15,   -11,   -15,   -15,
       1,   -15,   -14,   -15,    -3
};
...
{
      13,    14,    15,    16,     2,    21,    18,     3,     4,     5,
       6,    42,    43,    44,    45,    26,    39,    28,    32,    33,
      34,    35,    36,    37,    47,    12,    48,    17,    20,    29,
      40,    41,     0,    30,    31
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     0,    16,     7,     3,     4,     5,
       6,    13,    14,    15,    16,    18,    27,    20,    18,    19,
      20,    21,    22,    23,    38,    17,    40,     9,     8,    10,
      18,    30,    -1,    12,    11
};
...
{
       0,    25,     0,     3,     4,     5,     6,    26,    27,    28,
      29,    30,    17,    38,    38,    38,    38,     9,     7,    31,
       8,    31,    34,    35,    38,    32,    38,    33,    38,    10,
      12,    11,    18,    19,    20,    21,    22,    23,    37,    31,
      18,    34,    13,    14,    15,    16,    36,    36,    36
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 8: /* create_op: NUEVO id LBRACE pares RBRACE  */
#line 338 "NQL.y"
        { op_create((yyvsp[-3].sval), (yyvsp[-1].plist)); free((yyvsp[-3].sval)); }
#line 1390 "NQL.tab.c"
    break;

  case 9: /* read_op: BUSCAR id condicion_opt  */
#line 344 "NQL.y"
        { op_read((yyvsp[-1].sval), &(yyvsp[0].cond)); free((yyvsp[-1].sval)); }
#line 1396 "NQL.tab.c"
    break;

  case 10: /* update_op: ACTUALIZAR id ASIGNAR asignacion condicion_opt  */
#line 350 "NQL.y"
        { op_update((yyvsp[-3].sval), &(yyvsp[-1].asgn), &(yyvsp[0].cond)); free((yyvsp[-3].sval)); }
#line 1402 "NQL.tab.c"
    break;

  case 11: /* delete_op: ELIMINAR id condicion_opt  */
#line 356 "NQL.y"
        { op_delete((yyvsp[-1].sval), &(yyvsp[0].cond)); free((yyvsp[-1].sval)); }
#line 1408 "NQL.tab.c"
    break;

  case 12: /* condicion_opt: %empty  */
#line 362 "NQL.y"
        {
            (yyval.cond).active = 0;
            (yyval.cond).key[0] = '\0';
...
#line 1417 "NQL.tab.c"
  ...
  case 13: /* condicion_opt: DONDE condicion  */
#line 367 "NQL.y"
        { (yyval.cond) = (yyvsp[0].cond); }
#line 1423 "NQL.tab.c"
    break;

  case 14: /* condicion: id operador valor  */
#line 372 "NQL.y"
        {
            (yyval.cond).active = 1;
            strncpy((yyval.cond).key, (yyvsp[-2].sval), MAX_KEY_LEN - 1);
            (yyval.cond).op  = (yyvsp[-1].op);
            (yyval.cond).val = (yyvsp[0].vval);
            free((yyvsp[-2].sval));
        }
#line 1435 "NQL.tab.c"
    break;

  case 15: /* asignacion: id EQ valor  */
#line 384 "NQL.y"
        {
            strncpy((yyval.asgn).key, (yyvsp[-2].sval), MAX_KEY_LEN - 1);
            (yyval.asgn).val = (yyvsp[0].vval);
            free((yyvsp[-2].sval));
        }
#line 1445 "NQL.tab.c"
    break;
...
#line 1451 "NQL.tab.c"
  ...
  case 17: /* pares: par COMMA pares  */
#line 396 "NQL.y"
        { (yyvsp[-2].plist)->next = (yyvsp[0].plist); (yyval.plist) = (yyvsp[-2].plist); }
#line 1457 "NQL.tab.c"
    break;

  case 18: /* par: id COLON valor  */
#line 401 "NQL.y"
        {
            PairList *p = (PairList *)malloc(sizeof(PairList));
            strncpy(p->key, (yyvsp[-2].sval), MAX_KEY_LEN - 1);
            p->val  = (yyvsp[0].vval);
            p->next = NULL;
            free((yyvsp[-2].sval));
            (yyval.plist) = p;
...
#line 1470 "NQL.tab.c"
  ...
  case 19: /* valor: NUMBER  */
#line 414 "NQL.y"
        { (yyval.vval).type = VAL_NUMBER; (yyval.vval).num = (yyvsp[0].dval); }
#line 1476 "NQL.tab.c"
    break;

  case 20: /* valor: STRING_LIT  */
#line 416 "NQL.y"
        { (yyval.vval).type = VAL_STRING; strncpy((yyval.vval).str, (yyvsp[0].sval), MAX_STR_LEN - 1); free((yyvsp[0].sval)); }
#line 1482 "NQL.tab.c"
    break;

  case 21: /* valor: BOOLEAN  */
#line 418 "NQL.y"
        { (yyval.vval).type = VAL_BOOL; (yyval.vval).bval = (yyvsp[0].bval); }
#line 1488 "NQL.tab.c"
    break;

  case 22: /* valor: NUL  */
#line 420 "NQL.y"
        { (yyval.vval).type = VAL_NULL; }
#line 1494 "NQL.tab.c"
    break;
...
#line 1518 "NQL.tab.c"
  ...
  case 27: /* operador: GTE  */
#line 429 "NQL.y"
           { (yyval.op) = OP_GTE; }
#line 1524 "NQL.tab.c"
    break;

  case 28: /* operador: LTE  */
#line 430 "NQL.y"
           { (yyval.op) = OP_LTE; }
#line 1530 "NQL.tab.c"
    break;
